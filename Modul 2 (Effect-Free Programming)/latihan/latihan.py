...
# TODO 1 Buatlah Fungsi add_expense menggunakan pure-function
...
# TODO 2 Buatlah fungsi calculate_total_expenses menggunakan lamba-expression
...
def get_expenses_by_date(expenses, date):
    new_expenses = [expense for expense in expenses if expense['tanggal'] == date]
    return new_expenses

# TODO 4 Buatlah fungsi generate_expenses_report digunakan sebagai generator
...
# TODO 6 ubah fungsi ke dalam bentuk lambda
